...
class _CameraViewState extends State<CameraView> {
  ...
  void initState() {
    ...
    for (var i = 0; i < _camera.cameras.length; i++) {
      if (_camera.cameras[i].lensDirection == widget.initialDirection) {
        _cameraIndex = i;
      }
    }
    _startLiveFeed();
  ...
  Future _startLiveFeed() async {
    final camera = Get.find<CamController>().camera.value.cameras[_cameraIndex];
